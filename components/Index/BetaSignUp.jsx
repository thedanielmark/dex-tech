        ...
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            <div className="absolute inset-y-0 left-0 -z-10 w-full overflow-hidden ring-1 ring-white/5 lg:w-1/2">
              <svg
                className="absolute inset-x-0 top-0 -z-10 h-[64rem] w-full stroke-gray-100/20 [mask-image:radial-gradient(32rem_32rem_at_center,white,transparent)]"
                aria-hidden="true"
              >
                <defs>
                  <pattern
            ...
            <dl className="mt-10 max-w-xl space-y-8 text-xl leading-7 text-gray-200 lg:max-w-none">
              ...
              <div className="grid grid-cols-1 gap-x-5 gap-y-6 sm:grid-cols-2">
                <div className="col-span-2 md:col-span-1 rounded-md px-4 pb-1.5 pt-2.5 ring-2 ring-inset ring-secondary-700 focus-within:ring-2 focus-within:ring-secondary-600">
                  ...
                  <input
                    ...
                    className="block w-full border-0 px-0 py-2 bg-transparent !text-white font-bold placeholder-gray-400 focus:ring-0 sm:text-xl sm:leading-6"
                    style={{
