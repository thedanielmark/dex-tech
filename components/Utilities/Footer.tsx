    ...
    <footer id="contact" className="bg-white">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        <div className="mt-12 max-w-2xl text-xl sm:text-2xl mx-auto text-center font-semibold text-zinc-500">
          Building DexTech has been an incredibly fun effort across many people
          at DexTech and our frens at other companies. We&apos;re always looking
          to make DexTech better, so please let us know how we can improve.
        </div>
        ...
        <p className="mt-10 text-center text-md leading-5 text-zinc-500">
          ...
          DexTech and BlitzCraft Labs are trademarks of BlitzCraft Technologies.
        </p>
      </div>
    </footer>
  );
